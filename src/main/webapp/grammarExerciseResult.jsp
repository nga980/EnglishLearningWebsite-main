...
<%@page import="model.User, model.GrammarTopic, model.QuizQuestion" %> <%@taglib prefix="c" uri="jakarta.tags.core"%> <%@taglib prefix="fmt" uri="jakarta.tags.fmt"%> <!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Kết Quả Bài Tập Ngữ Pháp - English Learning</title> <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h1 class="result-title fade-in-up">
                            ...
                            Kết Quả Bài Tập Ngữ Pháp </h1>
                        <p class="result-subtitle fade-in-up stagger-1">
                            Chúc mừng bạn đã hoàn thành bài tập! </p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="score-card bounce-in stagger-2">
                <div class="score-display">
                    ...
                    <div class="action-buttons">
                        <a href="${pageContext.request.contextPath}/take-grammar-exercise?grammarTopicId=${grammarTopicId}" 
                           class="btn-modern btn-primary-modern"> <i class="fas fa-redo"></i>
                            Làm lại bài này
                        </a>
                        <a href="${pageContext.request.contextPath}/grammar-detail?topicId=${grammarTopicId}" 
                           class="btn-modern btn-secondary-modern"> <i class="fas fa-book-open"></i>
                            Quay lại chủ đề ngữ pháp </a>
                        <a href="${pageContext.request.contextPath}/grammar" 
                           class="btn-modern btn-info-modern"> <i class="fas fa-list"></i>
                            Xem các chủ đề ngữ pháp khác </a>
                    </div>
                </div>
            </div>
                ...
                <c:forEach var="result" items="${detailedResults}" varStatus="loop">
                    <div class="question-item fade-in-up stagger-${(loop.index % 4) + 1}">
                        <div class="question-text">
                            ...
                            <span><c:out value="${result.question.questionText}" escapeXml="false"/></span> </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (scorePercentage) {
                ...
                let currentScore = 0;
                const increment = finalScore / 50; // Tốc độ đếm
            ...
            const percentage = ${score / totalQuestions * 100}; // Tính toán percentage từ JSTL
            if (percentage >= 80) {
                setTimeout(() => {
                    createConfetti();
                }, 1000);
